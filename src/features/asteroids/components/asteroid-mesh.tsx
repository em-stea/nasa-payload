  ...
  return (
    ...
    >
      <defs>
        ...
        <radialGradient cx="34%" cy="28%" id={`${uid}-body`} r="78%">
        ...
        <pattern height="26" id={`${uid}-grid`} patternUnits="userSpaceOnUse" width="26">
          <path
            d="M 26 0 L 0 0 0 26"
            fill="none"
            opacity="0.12"
      ...
      <rect fill="var(--color-basic-970)" height={VIEW_HEIGHT} width={VIEW_WIDTH} />
      <rect fill={`url(#${uid}-grid)`} height={VIEW_HEIGHT} width={VIEW_WIDTH} />
      ...
      <g clipPath={`url(#${uid}-clip)`} fill="none" opacity="0.35" stroke="currentColor">
