  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-6 p-4 lg:grid-cols-4">
        <Stat label="Magnitude" value={event.severity} hint="As reported" accent={accent} />
        <Stat label="Drift" value={drift} hint={heading ? `Vector ${heading}` : 'Stationary'} />
        <Stat
          label="Span"
      ...
      <table className="w-full border-t border-border">
        ...
        <thead>
          <tr className="bg-muted">
            <th scope="col" className={cn(cell, 'px-4 py-2 text-left text-basic-500 uppercase')}>
              T-Stamp
            </th>
            <th scope="col" className={cn(cell, 'px-4 py-2 text-left text-basic-500 uppercase')}>
              Coord
            </th>
            <th scope="col" className={cn(cell, 'px-4 py-2 text-right text-basic-500 uppercase')}>
              Mag
            </th>
          </tr>
        </thead>
