    ...
    >
      <TelescopeViewport>
        <Container className="flex flex-col items-center gap-4 pb-10 text-center md:pb-14">
          ...
          <Heading as="h1" variant="title.2" className="text-basic-00">
            {/* El 404 lo dicen los planetas; para un lector de pantalla, acá. */}
            <span className="sr-only">Error 404. </span>
            Off the star chart
          </Heading>

          <Text variant="body.3" className="max-w-[58ch] text-basic-300">
          ...
          <div className="mt-1 flex flex-wrap items-center justify-center gap-3">
            ...
            <Button asChild variant="text-link" size="xs" className="text-basic-300">
