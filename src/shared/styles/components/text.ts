...
export const textVariants = cva(commonClassnames, {
  variants: {
    variant: {
      ...
      'button.2': 'text-4 lg:text-4 leading-[24px] lg:leading-[24px] font-bold',
      ...
      'meta.2': 'text-2_5 lg:text-2_5 leading-[15px] lg:leading-[15px] uppercase tracking-[1px]',
      'drawer.item': 'text-4 lg:text-4 leading-[24px] lg:leading-[24px]',
      'card.title': 'font-space-grotesk text-5 lg:text-5 leading-[28px] lg:leading-[28px]',
      'card.title.sm': 'font-space-grotesk text-4_5 lg:text-4_5 leading-[28px] lg:leading-[28px]',
      'card.stat': 'text-4 lg:text-4 leading-[24px] lg:leading-[24px]',
      'card.stat.label': 'text-2_5 lg:text-2_5 leading-[15px] lg:leading-[15px] uppercase',
    },
  },
  defaultVariants: {
    variant: 'body.1',
